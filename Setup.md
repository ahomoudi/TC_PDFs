...
cftime/1.0.1-fosscuda-2018b-Python-3.6.6,		- netcdf4-python/1.4.3-fosscuda-2018b-Python-3.6.6,
...
- GDAL/3.0.0-foss-2019a-Python-3.7.2,   		- GEOS/3.7.2-foss-2019a-Python-3.7.2 loaded.
